...
class devoirEnclasseController extends Controller
{
    ...
    public function index()
    {
        ...
        ->with('posts',devoirmaison::where('TYPEDEVOIR',0)->orderBy('ID_DEVOIR','DESC')->get());
    }
    ...
    {
        //
        return view('devoirs.devoirEnclasse.create');
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/devoirEnclasse')->with('message','DevoirEnclasse Ajouté!');
    }
    ...
    {
        return view('devoirs.devoirEnclasse.show')
    ...
    {
        return view('devoirs.devoirEnclasse.edit')
        ->with('post',devoirmaison::where('ID_DEVOIR',$id)->first());
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      {  $newFileName = uniqid().'-'.$request->titre.'.'.$request->fichier->extension();
        ...
        return redirect('/devoirs')->with('message','DevoirEnclasse Edité!');
    }
    ...
    public function destroy($id)
    {
        ...
        ->with('message','DevoirEnclasse Supprimé!');
    }
}
